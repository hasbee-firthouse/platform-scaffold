...
Spawn the generator agent to create and manage an agent team for the current group.
...
**Rules:**
- Do NOT mention the harness, `/auto`, agents, or the GAN loop. This is a developer README for the app.
